...
from pv_app.api.src.user_panel import address_management, cart_management, categories_management, coupon_management, notify_me_management, orders, products_management
